...
def insCon():
    ...
    with conn:
        cursor = conn.cursor()
        cursor.execute('CREATE TABLE If NOT EXISTS Contacts_Info ( ID INT, Name TEXT, Adrs TEXT, PhnNo1 INT, PhnNo2 INT, PhnNo3 INT,PhnNo4 INT, Email TEXT)')
        cursor.execute("INSERT INTO Contacts_Info( Name, Adrs, PhnNo1, PhnNo2, PhnNo3, PhnNo4, Email) values ( ?,?,?,?,?,?,?)",(conname, conadrs, phnno1, phnno2, phnno3, phnno4, email))
    conn.commit()
...
def FndCon():
    ...
    with conn:
        cursor = conn.cursor()
        cursor.execute("SELECT * FROM Contacts_Info WHERE Name like ?")
...
def updCon():
    ...
    with conn:
        cursor = conn.cursor()
        cursor.execute("UPDATE Contacts_Info set( Name, Adrs, PhnNo1, PhnNo2, PhnNo3, PhnNo4, Email) = ( ?,?,?,?,?,?,?)",(conname, conadrs, phnno1, phnno2, phnno3, phnno4, email))
    conn.commit()
...
def delCon():
    ...
    with conn:
        cursor = conn.cursor()
        cursor.execute("DELETE FROM Contacts_Info WHERE Name like ? and Adrs=? and PhnNo1 =? and PhnNo2 =? and PhnNo3 =? and PhnNo4 =? and Email =?",(conname, conadrs, phnno1, phnno2, phnno3, phnno4, email))
    conn.commit()
...
Button(root , text="Add" , bg="Green" , fg="White" , width=13 ,command=insCon).place(x=370 , y=620)
Button(root , text="Edit" , bg="Orange" , fg="White" , width=13 , command=updCon).place(x=260 , y=620)
Button(root , text="Delete" , bg="Red" , fg="White" , width=13 , command=delCon).place(x=150 , y=620)
...
Button(root , text="Add" , bg="Green" , fg="White" , width=13 ,command=insCon).place(x=857 , y=620)
Button(root , text="Edit" , bg="Orange" , fg="White" , width=13).place(x=747 , y=620)
Button(root , text="Delete" , bg="Red" , fg="White" , width=13 ).place(x=637 , y=620)
